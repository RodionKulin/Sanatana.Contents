...
{    
    ...
    {        
        ...
        //замена медиа тегов
        public static string ReplaceMedia(string html)
        {
        ...
        public static void ReplaceMedia(HtmlElement element)
        {
        ...
        //поиск изображений
        public static List<HtmlElement> FindElementsOfType(HtmlElement root, string type)
        {
        ...
        public static List<HtmlImageInfo> FindImages(HtmlElement root)
        {
